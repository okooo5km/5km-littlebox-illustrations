...
![技术债利息](examples/images/03-tech-debt-interest.png)

### 通胀压力篮

![通胀压力篮](examples/images/04-economics-inflation-baskets.png)

### 拖延不是懒

![拖延不是懒](examples/images/05-psychology-procrastination-clarity.png)

### 合同小字

![合同小字](examples/images/06-law-contract-small-print.png)

### 生态边界

![生态边界](examples/images/07-ecology-system-boundary.png)

这些图片是风格校准样例，不是构图模板。示例图均为压缩后的 PNG，使用时应该从当前内容重新发明隐喻，不要照抄旧案例的物件和布局。
...
│   │   ├── 03-tech-debt-interest.png
│   │   ├── 04-economics-inflation-baskets.png
│   │   ├── 05-psychology-procrastination-clarity.png
│   │   ├── 06-law-contract-small-print.png
│   │   └── 07-ecology-system-boundary.png
│   ├── prompts.md
│   └── theme-prompts.md
└── 5km-littlebox-illustrations/
    ├── SKILL.md
