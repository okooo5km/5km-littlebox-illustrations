...
- Amber identity tape has a small jagged / sawtooth torn front tab when the front lip is visible.
- Closed tape follows the central lid seam.
...
- there are multiple unrelated amber tape patches on Littlebox.
- the tape is too wide or reads like a whole orange flap.
- the tape lacks a jagged torn front tab when the front lip is visible.
- the front tape tab becomes a smooth rectangular sticker.
- Littlebox is open, half-open, cutaway, or has raised flaps.
- any visible box interior appears.
- the box looks like a laptop, toolbox, treasure chest, pizza box, tray, bucket, or mailbox because the lid is open.
...
- the body becomes a long carton, bridge, press machine, tray, pipe, or generic output package.
- large black arrows dominate the flow.
...
A strong Littlebox image should make the reader think: "That box is doing the idea." If the idea still works after removing Littlebox, the prompt failed.
